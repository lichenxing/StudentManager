...
<body class="ContentBody">
  <form action="AddTeachers.teacher" method="post" name="fom" id="fom" >
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<legend>编辑个人信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="41%"><input name="Username" id="Text1" value="" class="text" style="width:154px" /></td>
					  </tr>
					 
			        
					  <tr>
					    <td align="right" width="19%">密码:</td>
					    <td width="27%"><input name="Password" id="Input22" value="" class="text" style="width:154px" /></td>
					    </tr>
