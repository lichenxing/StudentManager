...
<%
    ...
    boolean isStudent = type == 1 ? true : false;
    
    
    
%>
<body class="ContentBody">
  <form action="UpdateInfo.users" method="post" name="fom" id="fom" >
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<legend>编辑个人信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="41%"><%=obj.getUsername() %> </td>
					  </tr>
					  <%
			       ...
			       %>
			        ...
			        <%} %>
					  <tr>
					    ...
					    <td width="27%"><input name="password" id="Input22" value="<%=obj.getPassword() %>" class="text" style="width:154px" /></td>
					    </tr>
