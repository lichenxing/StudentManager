...
<body class="ContentBody">
	<form action="AddStudent.student" method="post" name="fom" id="fom">
		<div class="MainDiv">
									...
									<fieldset style="height: 100%;">
										...
										<table border="0" cellpadding="2" cellspacing="1"
											...
											<tr>
												...
												<td width="41%"><input name="Username" id="Text1"
													value="" class="text" style="width: 154px" /></td>
											</tr>

											<tr>
												<td nowrap align="right">学号:</td>
												<td><input name="No" id="" class="text" value=""
											...
											<tr>
												...
												<td width="27%"><input name="Password" id="Input22"
													value="" class="text" style="width: 154px" /></td>
											</tr>
